        ...
        <div className="relative mx-auto max-w-5xl px-6 py-20 text-center md:py-28">
          <Reveal>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-[#5F6F80]">
              ...
              ontdekken welke opleiding aansluit bij jouw interesses,
              kwaliteiten en toekomstplannen.
            </p>
          ...
          <div className="mx-auto mt-14 grid max-w-4xl gap-4 md:grid-cols-3">
            {[
              { label: "Stap 1", text: "Quiz invullen" },
              { label: "Stap 2", text: "Richtingen ontdekken" },
              { label: "Stap 3", text: "Verdiepen en kiezen" },
            ].map((item, index) => (
              <Reveal key={item.label} delay={index * 100}>
                <div className="rounded-[24px] border border-[#D8CBB8] bg-[#F1E6D8] p-5 text-left shadow-[0_10px_30px_rgba(47,93,135,0.05)]">
                  <p className="text-sm text-[#6E8092]">{item.label}</p>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {benefits.map((benefit, index) => (
              <Reveal key={benefit.title} delay={index * 120}>
                <article className="rounded-[28px] border border-[#D8CBB8] bg-[#F5EBDD] p-7 shadow-[0_10px_25px_rgba(47,93,135,0.04)]">
